 ...
 *
 * Skrypt odbiera plik Excel z PWA i wysyła go mailem na wskazany adres
 */
...
<body>
    <div class=\"container\">
        <div class=\"header\">
            <h2>📦 ELMAR - Dokumenty Wydania</h2>
        </div>
        <div class=\"content\">
            <p>Witaj,</p>
            <p>W załączniku znajduje się plik Excel z dokumentami wydania produktów z magazynu.</p>
